...
class CyberGuardHandler(http.server.BaseHTTPRequestHandler):
    ...
    def generate_beautiful_html(self):
        """Generate the beautiful HTML interface with working JavaScript"""
        return '''<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="container">
        ...
        <div id="ussd-tab" class="tab-content active">
            ...
            <div class="examples">
                ...
                <div class="example-item" onclick="setUSSDExample('*901#')">
                    *901# - Safe banking code
                </div>
                <div class="example-item" onclick="setUSSDExample('*123#')">
                    *123# - Safe telecom code
                </div>
                <div class="example-item" onclick="setUSSDExample('*123*password*#')">
                    *123*password*# - Dangerous scam
                </div>
                <div class="example-item" onclick="setUSSDExample('*999*123#')">
                    *999*123# - Unknown code
                </div>
                <div class="example-item" onclick="setUSSDExample('*123*bvn*456#')">
        ...
        <div id="sms-tab" class="tab-content">
            ...
            <div class="examples">
                ...
                <div class="example-item" onclick="setSMSExample('Congratulations! You won $1,000,000 lottery! Call now to claim.')">
                    Lottery scam message
                </div>
                <div class="example-item" onclick="setSMSExample('Your account needs verification. Send your BVN immediately.')">
                    BVN verification scam
                </div>
                <div class="example-item" onclick="setSMSExample('Free iPhone! Click http://bit.ly/free-iphone to claim now!')">
                    Free gift scam with URL
                </div>
                <div class="example-item" onclick="setSMSExample('Hi John, are we still meeting tomorrow at 3 PM?')">
                    Legitimate message
                </div>
                <div class="example-item" onclick="setSMSExample('Your password needs resetting. Reply with your PIN for verification.')">
                    Password reset scam
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        // USSD example setter
        function setUSSDExample(code) {
            document.getElementById('ussdInput').value = code;
        }

        // SMS example setter
        function setSMSExample(message) {
        ...
        // Add interactive effects after page load
        document.addEventListener('DOMContentLoaded', function() {
            console.log('CyberGuard interface loaded');
...
print(f"🚀 Starting CyberGuard Web Interface with Fixed JavaScript...")
print(f"📍 Open: http://localhost:{PORT}")
print(f"🎯 All tabs and buttons should now work!")
