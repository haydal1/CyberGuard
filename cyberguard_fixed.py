...
class CyberGuardHandler(http.server.SimpleHTTPRequestHandler):
    ...
    def handle_stats(self):
        ...
        stats = {
            ...
            "scam_keywords": len(self.database["scam_keywords"]),
            "status": "online"
        }
...
<body>
    ...
    def handle_check(self):
        ...
        # Ensure response is always valid JSON with expected fields
        if "message" not in result:
            result = {"message": "Unknown error", "color": "gray"}
...
print(f"🚀 Starting FIXED CyberGuard Interface...")
print(f"📍 Open: http://localhost:8001")
print(f"✅ Fixed JSON responses")
print(f"✅ Added /stats endpoint")
